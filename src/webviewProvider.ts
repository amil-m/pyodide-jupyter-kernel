...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src ${webview.cspSource} 'unsafe-inline'; script-src 'nonce-${nonce}' 'unsafe-eval'; script-src-elem 'nonce-${nonce}' https://cdn.jsdelivr.net; worker-src blob:; connect-src https://cdn.jsdelivr.net ${webview.cspSource} http://localhost:* http://127.0.0.1:*;">
